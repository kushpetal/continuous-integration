# Continuous Integration ![https://github.com/kushpetal/continuous-integration/actions?query=workflow%3Atests](https://github.com/kushpetal/continuous-integration/workflows/tests/badge.svg)
